    ...
    <div className="flex h-full flex-col overflow-hidden">
      <header className="flex h-16 shrink-0 items-center justify-between border-b px-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Checks templates, front matter versions, missing files, corrupt JSON, broken AIDD links, and source workspace configuration. It does not score delivery readiness.</p>
        </div>
