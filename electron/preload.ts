...
contextBridge.exposeInMainWorld('aidd', {
  ...
  packageChangeForReview: (input: unknown) => ipcRenderer.invoke('project:packageChangeForReview', input),
  importChangeReviewPackage: (input: unknown) => ipcRenderer.invoke('project:importChangeReviewPackage', input),
  deleteChange: (input: unknown) => ipcRenderer.invoke('project:deleteChange', input),
  readRoadmap: (projectPath: string) => ipcRenderer.invoke('project:readRoadmap', projectPath),
  ...
  returnDeliveryPackageToChanges: (input: unknown) => ipcRenderer.invoke('project:returnDeliveryPackageToChanges', input),
